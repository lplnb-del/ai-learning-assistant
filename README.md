...
src/ai_study_agent/
  ...
  core/                   配置、领域类型、服务接口
  llm/                    LLM Gateway + Model Factory（OpenAI 兼容 / Ollama / HuggingFace）
  knowledge/              知识库管理
  ingestion/              文档导入与切分
